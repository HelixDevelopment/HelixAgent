...
func TestNewProviderWithCustomURL(t *testing.T) {
	...
	provider := NewUpstageProvider("test-key", customURL, "custom-model")
...
func TestNewProviderWithRetry(t *testing.T) {
	...
	provider := NewUpstageProviderWithRetry("test-key", "", "", retryConfig)
...
func TestComplete(t *testing.T) {
	...
	provider := NewUpstageProvider("test-api-key", server.URL, "")
	...
	assert.Equal(t, "upstage", resp.ProviderID)
}
...
func TestCompleteStream(t *testing.T) {
	...
	provider := NewUpstageProvider("test-key", server.URL, "")
...
func TestValidateConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			t.Parallel()
			provider := NewUpstageProvider(tt.apiKey, "", "")
