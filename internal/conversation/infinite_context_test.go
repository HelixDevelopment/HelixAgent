...
func (m *mockBroker) Publish(_ context.Context, _ string, _ *messaging.Message, _ ...messaging.PublishOption) error {
	return nil
}

func (m *mockBroker) PublishBatch(_ context.Context, _ string, _ []*messaging.Message, _ ...messaging.PublishOption) error {
	return nil
}

func (m *mockBroker) Subscribe(_ context.Context, _ string, _ messaging.MessageHandler, _ ...messaging.SubscribeOption) (messaging.Subscription, error) {
	return nil, nil
}

func (m *mockBroker) BrokerType() messaging.BrokerType {
	return messaging.BrokerTypeInMemory
}

func (m *mockBroker) GetMetrics() *messaging.BrokerMetrics {
	return messaging.NewBrokerMetrics()
}
