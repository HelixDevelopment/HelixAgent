...
func TestNewProviderWithCustomURL(t *testing.T) {
	...
	provider := NewHyperbolicProvider("test-key", customURL, "custom-model")
...
func TestNewProviderWithRetry(t *testing.T) {
	...
	provider := NewHyperbolicProviderWithRetry("test-key", "", "", retryConfig)
...
func TestComplete(t *testing.T) {
	...
	provider := NewHyperbolicProvider("test-api-key", server.URL, "")
	...
	assert.Equal(t, "hyperbolic", resp.ProviderID)
}
...
func TestCompleteWithError(t *testing.T) {
	...
	provider := NewHyperbolicProvider("invalid-key", server.URL, "")
...
func TestCompleteStream(t *testing.T) {
	...
	provider := NewHyperbolicProvider("test-key", server.URL, "")
...
func TestValidateConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			t.Parallel()
			provider := NewHyperbolicProvider(tt.apiKey, "", "")
