 ...
 */
export declare function parseAllowedOrigins(raw: string | readonly string[] | undefined): string[];
/**
 ...
 * emitted at all.
 */
export declare function originHeaders(origin: string | undefined, allowed: ReadonlySet<string>): Record<string, string>;
