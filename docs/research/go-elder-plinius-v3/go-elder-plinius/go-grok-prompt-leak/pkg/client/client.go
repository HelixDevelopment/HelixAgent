...
func (c *Client) Search(ctx context.Context, opts SearchOptions) ([]PromptEntry, int, error) {
	if err := opts.Validate(); err != nil {
		return nil, 0, errors.Wrap(errors.ErrCodeInvalidArgument, "grok-prompt-leak", "invalid parameters", err)
	}
	opts.Defaults()
	return nil, 0, errors.New(errors.ErrCodeUnimplemented, "grok-prompt-leak",
