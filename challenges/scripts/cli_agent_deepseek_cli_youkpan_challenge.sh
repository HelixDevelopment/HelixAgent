#!/bin/bash
#===============================================================================
# HELIXAGENT CLI-AGENT CHALLENGE — deepseek_cli_youkpan
#===============================================================================
# Auto-generated wrapper around _cli_agent_challenge_common.sh.
# Exercises the 25-prompt suite against HelixAgent using the deepseek-cli-youkpan
...
AGENT_NAME="deepseek_cli_youkpan"
AGENT_DISPLAY_NAME="deepseek-cli-youkpan"
AGENT_BIN="deepseek"
